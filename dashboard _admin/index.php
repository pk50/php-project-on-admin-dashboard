    ...
    <div class="page-container">
		...
		<div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="login.php"><!--<img src="assets/images/icon/logo.png" alt="logo">--><h4><strong>ADMIN</h4></strong></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
							...
							<!--<h4 class="user-name dropdown-toggle" data-toggle="dropdown">PK <i class="fa fa-angle-down"></i></h4>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2018. All right reserved. Template by <a href="https://colorlib.com/wp/">Pk</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
